...
List<Edge> defineEdges() {
  ...
  // Start of edge defines
  Edges.add(new Edge(   0,   3,  66,  true,   0,   1,  0));
  Edges.add(new Edge(   0,   3, 134,  true,   1,   2,  0));
  Edges.add(new Edge(   0,   3, 100,  true,   2,   0,  0));
  Edges.add(new Edge(   0,   2,  68,  true,   0,   4,  0));
  Edges.add(new Edge(   0,   2, 101, false,   0,   5,  0));
  Edges.add(new Edge(   0,   2, 134,  true,   1,   5,  0));
  Edges.add(new Edge(   0,   3,  32,  true,   1,   3,  0));
  Edges.add(new Edge(   0,   2,   2,  true,   2,   3,  0));
  Edges.add(new Edge(   0,   2,  36, false,   2,   4,  0));
  Edges.add(new Edge(   0,   5, 102, false,   3,   4,  0));
  Edges.add(new Edge(   0,   1,  33, false,   4,   5,  0));
  Edges.add(new Edge(   0,   0,  33,  true,   5,   3,  0));
  Edges.add(new Edge(   0,   5,  68,  true,   3,   7,  0));
  ...
  Edges.add(new Edge(   0,  17, 136,  true,  30,  28,  0));
  Edges.add(new Edge(   0,  19,   1,  true,  28,  32,  0));
  Edges.add(new Edge(   0,  19,  34, false,  28,  33,  0));
  Edges.add(new Edge(   0,  19,  67,  true,  29,  33,  0));
  Edges.add(new Edge(   0,  19, 101, false,  29,  31,  0));
  Edges.add(new Edge(   0,  19, 133,  true,  30,  31,  0));
  Edges.add(new Edge(   0,  17,  34,  true,  30,  32,  0));
  Edges.add(new Edge(   0,  18, 102, false,  31,  32,  0));
  Edges.add(new Edge(   0,  23,  33, false,  32,  33,  0));
  Edges.add(new Edge(   0,  20,  33,  true,  33,  31,  0));
  Edges.add(new Edge(   0,  18,  67,  true,  31,  35,  0));
  Edges.add(new Edge(   0,  20,   0,  true,  31,  36,  0));
  Edges.add(new Edge(   0,  23,   0,  true,  32,  36,  0));
  Edges.add(new Edge(   0,  18,   0, false,  32,  34,  0));
  Edges.add(new Edge(   0,  20,  67, false,  33,  34,  0));
